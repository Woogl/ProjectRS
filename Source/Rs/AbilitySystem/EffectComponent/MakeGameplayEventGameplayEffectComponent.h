...
#include "MakeGameplayEventGameplayEffectComponent.generated.h"

/**
 * 
 */
UCLASS(DisplayName="Make Gameplay Event")
class RS_API UMakeGameplayEventGameplayEffectComponent : public UGameplayEffectComponent
{
	GENERATED_BODY()
