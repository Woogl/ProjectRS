...
#include "RsInstantEffectComponent.generated.h"

class URsUnitEffect_Instant;
/**
 * 
 */
UCLASS()
class RS_API URsInstantEffectComponent : public UGameplayEffectComponent
{
	GENERATED_BODY()

	UPROPERTY(EditDefaultsOnly)
	TSubclassOf<URsUnitEffect_Instant> Effect;
