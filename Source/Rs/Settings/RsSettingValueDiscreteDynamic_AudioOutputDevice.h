...
#include "RsSettingValueDiscreteDynamic_AudioOutputDevice.generated.h"
...
UCLASS()
class URsSettingValueDiscreteDynamic_AudioOutputDevice : public UGameSettingValueDiscreteDynamic
{
	GENERATED_BODY()
	
public:

	virtual ~URsSettingValueDiscreteDynamic_AudioOutputDevice() = default;
