...
static TAutoConsoleVariable<bool> CVarLatencyMarkersRequireNVIDIA(TEXT("Rs.Settings.LatencyMarkersRequireNVIDIA"),
	true,
...
public:
	...
	{
		if (!URsSettingsLocal::DoesPlatformSupportLatencyTrackingStats())
		{
...
public:
	...
	virtual void GatherEditState(const ULocalPlayer * InLocalPlayer, FGameSettingEditableState & InOutEditState) const override
	{
		if (!URsSettingsLocal::DoesPlatformSupportLatencyMarkers())
		{
			InOutEditState.Disable(LOCTEXT("PlatformDoesNotSupportLatencyMarkers", "Latency markers are not supported on this device"));
		}

		// Rs is only going to use the "Reflex" plugin to track these latency stats, so restrict these settings to NVIDIA devices. 
...
void URsGameSettingRegistry::AddPerformanceStatPage(UGameSettingCollection* PerfStatsOuterCategory, URsLocalPlayer* InLocalPlayer)
{
	//----------------------------------------------------------------------------------
	{
		static_assert((int32)ERsDisplayablePerformanceStat::Count == 18, "Consider updating this function to deal with new performance stats");
		...
		////////////////////////////////////////////////////////////////////////////////////
		{
			...
			//----------------------------------------------------------------------------------
			{
				URsSettingValueDiscrete_PerfStat* Setting = NewObject<URsSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ERsDisplayablePerformanceStat::ClientFPS);
			...
			{
				URsSettingValueDiscrete_PerfStat* Setting = NewObject<URsSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ERsDisplayablePerformanceStat::ServerFPS);
			...
			{
				URsSettingValueDiscrete_PerfStat* Setting = NewObject<URsSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ERsDisplayablePerformanceStat::FrameTime);
			...
			{
				URsSettingValueDiscrete_PerfStat* Setting = NewObject<URsSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ERsDisplayablePerformanceStat::IdleTime);
			...
			{
				URsSettingValueDiscrete_PerfStat* Setting = NewObject<URsSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ERsDisplayablePerformanceStat::FrameTime_GameThread);
			...
			{
				URsSettingValueDiscrete_PerfStat* Setting = NewObject<URsSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ERsDisplayablePerformanceStat::FrameTime_RenderThread);
			...
			{
				URsSettingValueDiscrete_PerfStat* Setting = NewObject<URsSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ERsDisplayablePerformanceStat::FrameTime_RHIThread);
			...
			{
				URsSettingValueDiscrete_PerfStat* Setting = NewObject<URsSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ERsDisplayablePerformanceStat::FrameTime_GPU);
		...
		////////////////////////////////////////////////////////////////////////////////////
		{
			...
			{
				URsSettingValueDiscrete_PerfStat* Setting = NewObject<URsSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ERsDisplayablePerformanceStat::Ping);
			...
			{
				URsSettingValueDiscrete_PerfStat* Setting = NewObject<URsSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ERsDisplayablePerformanceStat::PacketLoss_Incoming);
			...
			{
				URsSettingValueDiscrete_PerfStat* Setting = NewObject<URsSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ERsDisplayablePerformanceStat::PacketLoss_Outgoing);
			...
			{
				URsSettingValueDiscrete_PerfStat* Setting = NewObject<URsSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ERsDisplayablePerformanceStat::PacketRate_Incoming);
			...
			{
				URsSettingValueDiscrete_PerfStat* Setting = NewObject<URsSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ERsDisplayablePerformanceStat::PacketRate_Outgoing);
			...
			{
				URsSettingValueDiscrete_PerfStat* Setting = NewObject<URsSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ERsDisplayablePerformanceStat::PacketSize_Incoming);
			...
			{
				URsSettingValueDiscrete_PerfStat* Setting = NewObject<URsSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ERsDisplayablePerformanceStat::PacketSize_Outgoing);
		...
		////////////////////////////////////////////////////////////////////////////////////
		{
			...
			//----------------------------------------------------------------------------------
			{
				...
				Setting->SetDefaultValue(URsSettingsLocal::DoesPlatformSupportLatencyTrackingStats());
			...
			{
				URsSettingValueDiscrete_PerfStat* Setting = NewObject<URsSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ERsDisplayablePerformanceStat::Latency_Total);
			...
			{
				URsSettingValueDiscrete_PerfStat* Setting = NewObject<URsSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ERsDisplayablePerformanceStat::Latency_Game);
			...
			{
				URsSettingValueDiscrete_PerfStat* Setting = NewObject<URsSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ERsDisplayablePerformanceStat::Latency_Render);
