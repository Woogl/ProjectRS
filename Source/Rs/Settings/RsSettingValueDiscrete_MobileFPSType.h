...
#include "RsSettingValueDiscrete_MobileFPSType.generated.h"
...
UCLASS()
class URsSettingValueDiscrete_MobileFPSType : public UGameSettingValueDiscrete
{
	GENERATED_BODY()
	
public:

	URsSettingValueDiscrete_MobileFPSType();
