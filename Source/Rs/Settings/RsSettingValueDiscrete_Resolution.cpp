...
#include UE_INLINE_GENERATED_CPP_BY_NAME(RsSettingValueDiscrete_Resolution)

#define LOCTEXT_NAMESPACE "LyraSettings"

URsSettingValueDiscrete_Resolution::URsSettingValueDiscrete_Resolution()
{
}

void URsSettingValueDiscrete_Resolution::OnInitialized()
{
	Super::OnInitialized();
...
void URsSettingValueDiscrete_Resolution::StoreInitial()
{
	// Ignored
}

void URsSettingValueDiscrete_Resolution::ResetToDefault()
{
	// Ignored
}

void URsSettingValueDiscrete_Resolution::RestoreToInitial()
{
	// Ignored
}

void URsSettingValueDiscrete_Resolution::SetDiscreteOptionByIndex(int32 Index)
{
...
int32 URsSettingValueDiscrete_Resolution::GetDiscreteOptionIndex() const
{
...
TArray<FText> URsSettingValueDiscrete_Resolution::GetDiscreteOptions() const
{
...
void URsSettingValueDiscrete_Resolution::OnDependencyChanged()
{
...
void URsSettingValueDiscrete_Resolution::InitializeResolutions()
{
	Resolutions.Empty();
...
void URsSettingValueDiscrete_Resolution::SelectAppropriateResolutions()
{
...
bool URsSettingValueDiscrete_Resolution::ShouldAllowFullScreenResolution(const FScreenResolutionRHI& SrcScreenRes, int32 FilterThreshold) const
{
...
int32 URsSettingValueDiscrete_Resolution::FindIndexOfDisplayResolution(const FIntPoint& InPoint) const
{
...
int32 URsSettingValueDiscrete_Resolution::FindIndexOfDisplayResolutionForceValid(const FIntPoint& InPoint) const
{
...
int32 URsSettingValueDiscrete_Resolution::FindClosestResolutionIndex(const FIntPoint& Resolution) const
{	
	int32 Index = 0;
...
void URsSettingValueDiscrete_Resolution::GetStandardWindowResolutions(const FIntPoint& MinResolution, const FIntPoint& MaxResolution, float MinAspectRatio, TArray<FIntPoint>& OutResolutions)
{
...
FText URsSettingValueDiscrete_Resolution::FScreenResolutionEntry::GetDisplayText() const
{
