...
#include UE_INLINE_GENERATED_CPP_BY_NAME(RsSettingValueDiscrete_OverallQuality)

#define LOCTEXT_NAMESPACE "RsSettings"

URsSettingValueDiscrete_OverallQuality::URsSettingValueDiscrete_OverallQuality()
{
}

void URsSettingValueDiscrete_OverallQuality::OnInitialized()
{
	Super::OnInitialized();

	URsSettingsLocal* UserSettings = URsSettingsLocal::Get();
...
void URsSettingValueDiscrete_OverallQuality::StoreInitial()
{
}

void URsSettingValueDiscrete_OverallQuality::ResetToDefault()
{
}

void URsSettingValueDiscrete_OverallQuality::RestoreToInitial()
{
}

void URsSettingValueDiscrete_OverallQuality::SetDiscreteOptionByIndex(int32 Index)
{
...
int32 URsSettingValueDiscrete_OverallQuality::GetDiscreteOptionIndex() const
{
...
TArray<FText> URsSettingValueDiscrete_OverallQuality::GetDiscreteOptions() const
{
	const int32 OverallQualityLevel = GetOverallQualityLevel();
	if (OverallQualityLevel == INDEX_NONE)
	{
...
int32 URsSettingValueDiscrete_OverallQuality::GetCustomOptionIndex() const
{
	return OptionsWithCustom.Num() - 1;
}

int32 URsSettingValueDiscrete_OverallQuality::GetOverallQualityLevel() const
{
