...
#include "RsSettingValueDiscrete_Language.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(RsSettingValueDiscrete_Language)

#define LOCTEXT_NAMESPACE "RS"

static const int32 SettingSystemDefaultLanguageIndex = 0;

URsSettingValueDiscrete_Language::URsSettingValueDiscrete_Language()
{
}

void URsSettingValueDiscrete_Language::OnInitialized()
{
	Super::OnInitialized();
...
void URsSettingValueDiscrete_Language::StoreInitial()
{
	// ?
}

void URsSettingValueDiscrete_Language::OnApply()
{
...
void URsSettingValueDiscrete_Language::ResetToDefault()
{
	SetDiscreteOptionByIndex(SettingSystemDefaultLanguageIndex);
}

void URsSettingValueDiscrete_Language::RestoreToInitial()
{
	if (URsSettingsShared* Settings = CastChecked<URsLocalPlayer>(LocalPlayer)->GetSharedSettings())
	{
...
void URsSettingValueDiscrete_Language::SetDiscreteOptionByIndex(int32 Index)
{
	if (URsSettingsShared* Settings = CastChecked<URsLocalPlayer>(LocalPlayer)->GetSharedSettings())
	{
...
int32 URsSettingValueDiscrete_Language::GetDiscreteOptionIndex() const
{
	if (const URsSettingsShared* Settings = CastChecked<URsLocalPlayer>(LocalPlayer)->GetSharedSettings())
	{
...
TArray<FText> URsSettingValueDiscrete_Language::GetDiscreteOptions() const
{
