...
#include "RsSettingValueDiscrete_Resolution.generated.h"
...
UCLASS()
class URsSettingValueDiscrete_Resolution : public UGameSettingValueDiscrete
{
	GENERATED_BODY()
	
public:

	URsSettingValueDiscrete_Resolution();
