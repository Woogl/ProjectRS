...
#include UE_INLINE_GENERATED_CPP_BY_NAME(RsSettingAction_SafeZoneEditor)

class UGameSetting;

#define LOCTEXT_NAMESPACE "LyraSettings"

URsSettingAction_SafeZoneEditor::URsSettingAction_SafeZoneEditor()
{
...
TArray<UGameSetting*> URsSettingAction_SafeZoneEditor::GetChildSettings()
{
